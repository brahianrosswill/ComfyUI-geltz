        ...
        if hasattr(cs, "calculate_sigmas_scheduler"):
            ...
            def _wrapped(model_sampling, scheduler_name, steps):
                if scheduler_name == name:
                    return _hca_handler(model_sampling, steps)
